 ...
 * the License.
 */
package com.tutorial.batata.feign.soap;
 ...
 * 
 *    &#64;RequestLine("POST /buscarDados")
 *    &#64;Headers({
 *      "SOAPAction: buscarDados",
 *      "Content-Type: text/xml"
 *    })
 *    MyJaxbObjectResponse buscarDados(MyJaxbObjectRequest request);
 *    
 * }
 * 
 * ...
 ...
 *
 * try {
 *    api.buscarDados(new MyJaxbObjectRequest());
